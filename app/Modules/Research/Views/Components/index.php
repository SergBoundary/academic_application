        ...
        <div class="card text-dark bg-body shadow mb-2">
            <div class="card-header">
                ...
                <div class="float-end">
                    ...
                    <?php if (isset($_SESSION['user']) && $_SESSION['user']['username'] == $group['username']): ?>
                        <a href="/<?= $language ?>/<?= $group['username'] ?>/research/create" class="btn btn-outline-secondary btn-sm rounded-pill" title="Create new post"><i class="bi bi-plus-lg"></i></a>
                    <?php endif; ?>
                </div>
            </div>
