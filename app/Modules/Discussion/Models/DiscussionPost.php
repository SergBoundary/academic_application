...
class DiscussionPost extends Model
{
    ...
    {
        $sql = "INSERT INTO `discussion_posts` (`user_id`, `type`, `content`, `research_post_id`, `discussion_post_id`) 
                VALUES (:user_id, :type, :content, :research_post_id, :discussion_post_id)";
    ...
    public function updatePost($id, $type, $content, $researchId = null, $discussionId = null)
    {
        $sql = "UPDATE `discussion_posts` 
                SET `type` = :type, `content` = :content, `research_post_id` = :research_post_id, `discussion_post_id` = :discussion_post_id 
                WHERE id = :id";
